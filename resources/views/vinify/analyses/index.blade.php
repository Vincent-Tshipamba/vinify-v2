<x-app-layout>
    <div class="card p-10 shadow-lg rounded-lg dark:bg-neutral-800">
        <div class="card-body">
            <div class="table-responsive">
                <table border="1" id="analyses-table" class="table table-striped dark:text-gray-50 dark:bg-neutral-900 table-bordered rounded-md shadow-lg p-6">
                    <thead>
                        <tr>
    ...
    <script>
        if (document.getElementById("analyses-table") && typeof simpleDatatables.DataTable !== 'undefined') {
            ...
            const dataTable = new simpleDatatables.DataTable("#analyses-table", {
                searchable: true,
                sortable: true,
