...
<footer class="relative bg-neutral-900 overflow-hidden">
    <svg class="-bottom-20 absolute w-475 -translate-x-1/2 start-1/2 transform" width="2745" height="488"
    ...
    <div class="z-10 relative">
        <div class="mx-auto px-4 xl:px-0 py-10 lg:pt-16 w-full max-w-5xl">
            <div class="inline-flex items-center">
                ...
                <div class="ms-5 ps-5 border-neutral-700 border-s">
